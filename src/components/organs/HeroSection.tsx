...
import heroImage from "../../assets/tbc_logo/TBC-Logo.png";
...
const HeroSection = () => {
  return (
    <section className="w-full lg:h-[750px]  md:h-[550px] h-[700px] relative overflow-x-hidden flex justify-end">
      <Image
      ...
      <main className="w-full lg:h-[750px] grid md:grid-cols-2 absolute top-0 left-0 lg:px-24 md:px-8 px-5 pt-24 md:pt-32 lg:pt-0">
        <div className="flex flex-col justify-center gap-6 md:order-1">
          <Text
            as="p"
        ...
        <div className="flex flex-col items-center justify-end md:order-2">
          <Slide direction="right">
            <Image
              image={heroImage}
              alt="Hero Image"
              className=" lg:h-[90%] lg:w-[95%] md:h-[100%] md:w-full w-[90%] h-[50vh]"
            />
          </Slide>
        </div>
      </main>

...
const Services = ()=>{
    ...
    const renderIcons = useCallback((element: number) => {
        switch (element) {
            ...
            case 1:
                return <FaSlidersH size={15} color="currentColor" weight="fill" />;
            case 2:
                return <FaLink size={15} color="currentColor" weight="fill" />;
            case 3:
                return <FaChartLine size={15} color="currentColor" weight="fill" />;
            default:
                return "";
        }
    }, [])
    ...
    return (
        <section id="ABOUT" className="w-full  flex flex-col ">
            ...
            <main className="w-full bg-gradient-to-b from-gray-100 to-gray-100 pb-[20px] flex flex-col gap-12">
                ...
                >
                Why Choose Coherent Solutions for Your ERP system?
                </Text>
